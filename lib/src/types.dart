...
enum QrDataModuleShape {
  ...
  /// Use continues rect with rounded corners.
  roundedRect,
}
...
class QrEyeStyle {
  ...
  const QrEyeStyle({this.eyeShape, this.color, this.tearDropEyeRadius = 15.0});
  ...
  final double tearDropEyeRadius;
